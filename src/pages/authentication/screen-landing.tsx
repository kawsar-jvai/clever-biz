      ...
      <main className="relative flex flex-col items-stretch">
        ...
        <section className="w-full flex flex-col relative">
          ...
          <div className="flex-1 flex items-stretch">
            <div className="flex-1 flex flex-col justify-between gap-y-16 content-gap-start">
              <h1 className="text-5xl text-primary-text leading-tight">
                Our Service is made
                <br /> with love to delight you.
              </h1>

              <div className="flex-1 flex flex-col justify-center items-start">
                <img src={heroImage2} alt="tech" />
              </div>

              <p className="text-base text-primary-text/60 mb-16">
                Cleverbiz provides tailored, reliable solutions with a focus on
        ...
        <section className="bg-footer">
          <div className="content-container mx-auto">
            <h2 className="mt-16 text-start text-primary text-3xl font-bold">
              Available Packages
            </h2>
            <div className="flex flex-col md:flex-row md:justify-between md:gap-22 mt-16">
              {/* Subscription Pack 1 */}
              <div className="bg-white/40 shadow-2xl rounded-xl flex flex-col overflow-hidden group">
                {/* card label */}
                <div className="h-12 relative mt-8 mb-4">
                  <svg
                    className="absolute left-0 group-hover:-left-6 top-0 z-0 transition-all duration-300"
                    width="149"
                    height="48"
                    viewBox="0 0 149 48"
                    fill="none"
                  ...
                  >
                    <path
                      d="M149 48H0V0H149L130.487 24L149 48Z"
                      fill="#1B3275"
                    />
                  </svg>
                ...
                <div className="flex-1 flex flex-col p-4">
                  ...
                  <button className="button-primary text-primary-text font-medium w-full rounded-lg my-4 hover:scale-101">
                    Select
                  </button>
                  <Link
                    to="#"
